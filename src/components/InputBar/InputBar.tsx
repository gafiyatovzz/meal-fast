...
export function InputBar({
  ...
  hints, allHints, onHintClick, onMoreHints, disabled, textareaRef, onBarcode,
}: InputBarProps) {
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.inputBox}>
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="3" width="4" height="18" rx="0.5" fill="currentColor" stroke="none"/>
            <rect x="9" y="3" width="2" height="18" rx="0.5" fill="currentColor" stroke="none"/>
            <rect x="13" y="3" width="3" height="18" rx="0.5" fill="currentColor" stroke="none"/>
            <rect x="18" y="3" width="3" height="18" rx="0.5" fill="currentColor" stroke="none"/>
          </svg>
        </Button>
